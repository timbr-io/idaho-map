...
class Map(Component):
    ...
    #        out_kwargs.update({
    #            'driver': 'GTIFF',
    #            'height': 256, #window[0][1] - window[0][0],
    #            'width': 256, #window[1][1] - window[1][0],
    ...
    #            print 'OUT', out.bounds
    #            out.write(vrt.read(1))#vrt.read(window=window)) 
    #        
    #        #profile = vrt.profile
    ...
    #        url = 'http://idaho.timbr.io/{}/TOAReflectance/2.vrt'.format( idaho_id )
    #        print url
